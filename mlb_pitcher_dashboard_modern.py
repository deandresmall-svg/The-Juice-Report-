    ...
    <div class="modern-hero">
        <div class="modern-hero-row">
            <div class="modern-title-wrap">
                ...
                <div>
                    <div class="modern-title">Pitcher Props Dashboard</div>
                    <div class="modern-subtitle">Model-first projections for strikeouts, earned runs, outs and score accuracy buckets.</div>
                </div>
            </div>
            <div class="hero-pills">
                <span class="hero-pill">K Projection</span>
                <span class="hero-pill">ER Risk</span>
                <span class="hero-pill">Outs Workload</span>
            </div>
        </div>
    </div>
    """,
