    ...
    <div class="modern-hero">
        <div class="modern-hero-row">
            <div class="modern-title-wrap">
                ...
                <div>
                    <div class="modern-title">1+ Hit Dashboard</div>
                    <div class="modern-subtitle">Calibrated hit probabilities, matchup fit, pitch-shape contact and score validation.</div>
                </div>
            </div>
            <div class="hero-pills">
                <span class="hero-pill">🎯 1+ Hit Model</span>
                <span class="hero-pill">⚾ 2+ Hit Upside</span>
                <span class="hero-pill">🧪 Backtest Ready</span>
            </div>
        </div>
    </div>
    """,
...
quick_tab, contact_tab, matchup_tab, bvp_tab, pitcher_tab, slate_tab, backtest_tab, notes_tab = st.tabs(
    [
        ...
        "Pitcher profile", "Slate Top 10 + 3-man generator", "Backtest & calibration", "Model notes"
    ]
)
